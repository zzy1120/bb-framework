...
import com.bb.web.framework.bean.FileParam;
...
import com.bb.web.framework.util.FileUtil;
...
public class UploadHelper {
    ...
    public static void init(ServletContext servletContext) {
        ...
        servletFileUpload = new ServletFileUpload(new DiskFileItemFactory(DiskFileItemFactory.DEFAULT_SIZE_THRESHOLD, repositry));
    ...
    public static Param createParam(HttpServletRequest request) {
        ...
        try {
            ...
            LOGGER.error("create param fialure ", e);
     ...
     * 批量上传文件
     */
    public static void updateFile(String basePath, List<FileParam> fileParamList) {
        try {
